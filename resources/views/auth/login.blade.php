        ...
        <div id="app">
            <div class="container">
                <div class="pb-4 text-center" style="padding-top: 170px">
                    <div class="pb-4 h2 font-weight-bold">СТУДЕНСКИ ВЕБ СЕРВИС</div>
                ...
                <div class="pt-2 d-flex justify-content-center">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <label for="password" class="sr-only">ЈМБГ</label>
                            <input id="password" placeholder="ЈМБГ" type="password" class="text-center form-control @error('username') is-invalid @enderror @error('password') is-invalid @enderror" name="password" required oninvalid="this.setCustomValidity('Унесите матични број!')"  oninput="setCustomValidity('')">
                        ...
                        <div class="pt-3 form-group d-flex justify-content-between">
                            <button type="button" id="popup" class="btn btn-danger" style="box-shadow: none">
                                Формат пријаве
                            </button>
