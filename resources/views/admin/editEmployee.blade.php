...
<div class="container pt-4">
    <form action="{{ route('admin.updateEmployee', $employee->id) }}" method="POST">
        ...
        <div class="form-group row pl-5">
            ...
            <div class="col-md-3">
                <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ $employee->username }}" required oninvalid="this.setCustomValidity('Унесите корисничко име!')" oninput="setCustomValidity('')" autocomplete="username">
