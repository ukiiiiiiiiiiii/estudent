<table class="table" id="table_data_filter">
    ...
    <tr>
        <th class="col-md-2 border-top-0 pt-0 skip-filter" style="color: #285586"></th>
        <th class="col-md-3 text-center border-top-0 pt-0" style="color: #285586">Сви студијски програми</th>
        <th class="col-md-3 text-center border-top-0 pt-0" style="color: #285586">Сви предмети</th>
        <th class="col-md-2 text-center border-top-0 pt-0" style="color: #285586">Све оцене</th>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="{{ route('employee.updateResult2') }}" method="post">
                                    @csrf
