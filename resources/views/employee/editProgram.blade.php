        ...
        <div class="card-body">
            <form action="{{ route('employee.updateProgram', $program->id) }}" method="POST">
                ...
                <div class="form-group row pt-3">
                    ...
                    <div class="col-md-7">
                        <input id="program_name" type="text" class="form-control @error('program_name') is-invalid @enderror" name="program_name" value="{{ $program->name }}" required oninvalid="this.setCustomValidity('Унесите назив студијског програма!')" oninput="setCustomValidity('')" autofocus>
