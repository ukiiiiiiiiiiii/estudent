...
@section('content')
    <ul class="nav nav-tabs justify-content-center">
        ...
        <li id="dropdown-tab" class="nav-item dropdown active mr-1">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item active disabled" href="{{ route('employee.showUnsuccessfullyExams') }}">Неуспешна полагања</a>
            </div>
        </li>
    </ul>
    <div class="container pt-4">
        ...
        <div id="fetch_unsuccessfullyExams_data">
            @include('employee.unsuccessfullyExams_data')
        </div>
    </div>
    ...
    <script src="{{ asset('js/unsuccessfullyExams.js') }}"></script>
@endsection
